...
export const enrichLinkedIn = (id, linkedinUrl) =>
  http.post(`/users/${id}/linkedin/enrich`, { linkedin_url: linkedinUrl }).then(r => r.data)
export const disconnectLinkedIn = (id) => http.delete(`/users/${id}/linkedin`)
