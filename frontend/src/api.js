...
export const getLinkedInConnectUrl = (id) =>
  `${import.meta.env.VITE_API_URL || '/api'}/linkedin/connect?user_id=${id}`
export const disconnectLinkedIn = (id) => http.delete(`/linkedin/disconnect/${id}`)
