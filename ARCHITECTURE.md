...
| Post-scoring reorder pass — Haiku career advisor reviews all 15 candidates and promotes better goal-aligned jobs into top 3 when scoring-by-skills would otherwise misrank | ✅ | - | - |
| Admin debug page — Check Candidates step removed (redundant); LLM Score split into LLM 1 Score (Haiku batch) + LLM 2 Score (Haiku reorder) as separate triggerable steps | ✅ | - | - |
